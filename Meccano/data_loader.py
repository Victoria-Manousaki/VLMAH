...
from utils import import_pre_extracted, calculate_timesteps, Add_Noise, Add_Noise_Action, Add_Noise_Action_ShortLong, Add_Noise_ShortLong
                ...
                if (token_list[i] == 1 & (token_list[i - 1] != 33 or token_list[i - 1] != 34 or token_list[i + 1] != 33 or token_list[i + 1] != 34)):
                    ...
                    if unique_combos:
                        if [token_list[i - 2], token_list[i - 1]] not in unique_combos:
                            if token_list[i - 2] not in [1, 33, 34] and token_list[i - 1] not in [1, 33, 34]:
